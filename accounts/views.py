    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if check1 or check2 or check3:
                ...
                subject = 'Welcome to Django Polls'
                email_messages = f'Hi {user.username}, thanks for registering in Django Polls.'
                email_from = settings.EMAIL_HOST_USER
                recipient_list = [user.email, ]
                session_mail = user.email
                send_mail(subject, email_messages, email_from, recipient_list)

                # send_mail("New Order!", "Hey buddy, you have a new order",
                # "buzzhelio2901@gmail.com", [user.email], fail_silently=False)
