...
# from .views import send_email_to_clint
...
def poll_vote(request, poll_id):
    ...
    if choice_id:
        ...
        subject = 'Thank You For Voting to Django Polls'
        email_messages = f'Hi {recipient_name}, thanks for your vote in Django Polls.Your vote is as follows {vote}'
        email_from = settings.EMAIL_HOST_USER
        recipient_list = [recipient_mail, ]
        send_mail(subject, email_messages, email_from, recipient_list)
